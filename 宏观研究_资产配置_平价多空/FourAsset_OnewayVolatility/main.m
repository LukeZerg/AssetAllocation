...
currentFolder = 'D:\001Work\宏观研究_资产配置_平价多空\FourAsset_OnewayVolatility';
...
global strategy
strategy.cycle = 'w';  %频率 m w
strategy.MA_LEN = 40; %长期收益率及波动率平滑窗口
strategy.VOL_LEN = 10; %波动率计算窗口
strategy.THRESHOLD = [0.15, 0.025, 0.125, 0.03]; %简单大盘风格判断基准

strategy.capital = 650 * 10000;%总资产
%capital = 550 * 10000;%20170622仓位
%capital = 650 * 10000;%20170626仓位
