...
currentFolder = 'D:\001Work\宏观研究_资产配置_平价多空\OneAsset';
addpath(genpath(currentFolder))

%原始数据时间
% startday_dt = '2012-07-01';
% endday_dt = '2017-03-14';
startday_dt = '2015-01-01';
endday_dt = '2017-06-29';
%输入策略时间
%startdayInput = '2017-06-01';
startdayInput = '2017-01-01';
enddayInput = '2017-06-29';   

backtime = 225;%风险平价模型回溯窗口
capital = 400 * 10000;%20170619仓位
...
[startday, endday, data, names] = ...
    getData_BOND(startday_dt,endday_dt,startdayInput,...
...
open output
myplot_oneAsset(AssetAll,theWeights)
