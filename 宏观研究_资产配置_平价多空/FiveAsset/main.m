...
currentFolder = 'D:\001Work\宏观研究_资产配置_平价多空\FiveAsset';
...
%% 取出并整理平价多空策略需要的数据
%不包括逆回购的三个资产
names = {{'沪深300'},{'南华商品指数'},{'恒生ETF'},{'国债'},{'黄金'}};
...
[data_ft] = ...
getFutureData(startday_dt,endday_dt);%获取期货主力合约
...
open output
myplot_FiveAsset(AssetAll,AssetData,theWeights)
