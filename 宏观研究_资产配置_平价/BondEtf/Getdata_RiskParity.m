...
endday_dt = '2017-08-25';
currentFolder = 'D:\001Work\宏观研究_资产配置_平价\NewBackTest';
addpath(genpath(currentFolder))
currentFolder = 'D:\001Work\宏观研究_资产配置_平价\BondEtf';
addpath(genpath(currentFolder))
...
contract = {'511010.SH'};  %511010 比 159926交易量更大
Close3 = getETFdata(startday_dt, endday_dt, contract);
...
save('D:/001Work/宏观研究_资产配置_平价/BondETF/data_RiskParity.mat','Data','Close','Information');